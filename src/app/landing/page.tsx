  ...
  const demoSections = [
    {
      ...
      description: "Transform how you monitor, analyze, and optimize your energy consumption. Our intelligent platform provides real-time insights, predictive analytics, and actionable recommendations to help you save energy and reduce costs.",
      align: "left" as const,
      actions: [
        { label: "Get Started", variant: "primary" as const, onClick: () => console.log("Get started clicked") },
        { label: "View Dashboard", variant: "secondary" as const, onClick: () => console.log("Dashboard clicked") },
      ]
    },
    {
      id: "innovation",
      ...
      description: "Monitor your energy consumption in real-time across all your devices and locations. Our advanced sensors and AI algorithms provide instant feedback and alerts to help you make informed decisions about your energy usage.",
    ...
    },
    {
      ...
      title: "Smart",
      subtitle: "Insights",
      description: "Discover patterns in your energy consumption with our advanced analytics engine. Get personalized recommendations, identify inefficiencies, and optimize your energy usage with data-driven insights.",
      align: "left" as const,
      features: [
        { title: "Predictive Analytics", description: "Forecast future consumption and identify potential savings" },
        { title: "Cost Optimization", description: "Automated recommendations to reduce energy costs" },
        { title: "Environmental Impact", description: "Track and reduce your carbon footprint" }
      ]
    },
    {
      id: "future",
      ...
      title: "Green",
      subtitle: "Future",
      description: "Join thousands of users who are already saving energy and money while contributing to a sustainable future. EnergyHub makes it easy to monitor, analyze, and optimize your energy consumption for a better tomorrow.",
      align: "center" as const,
      actions: [
        { label: "Start Free Trial", variant: "primary" as const, onClick: () => console.log("Trial clicked") },
        { label: "Contact Sales", variant: "secondary" as const, onClick: () => console.log("Sales clicked") }
      ]
    }
  ];
